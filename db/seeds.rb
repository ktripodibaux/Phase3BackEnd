...
jeremy =    User.create(name: "Jeremy", userUrl: "jeremy.com")
zev =       User.create(name: "Zev", userUrl: "zev.com")
kurt =      User.create(name: "Kurt", userUrl: "kurt.com")
sam =       User.create(name: "Sam", userUrl: "Sam.com")
...
Game.create(score: 0, user_id: jeremy.id, question_id: q1.id)
Game.create(score: 1, user_id: kurt.id, question_id: q2.id)
Game.create(score: 1, user_id: zev.id, question_id: q1.id)
Game.create(score: 0, user_id: jeremy.id, question_id: q3.id)
Game.create(score: 0, user_id: jeremy.id, question_id: q4.id)
